...
#   PARAM_1_THROWS_DESC                 First parameter JSDoc throws description.
#   PARAM_2                             Second parameter name.
#   PARAM_2_VALUE                       Second parameter value.
...
#   PARAM_2_THROWS_DESC                 Second parameter JSDoc throws description.
#   PARAM_3                             Third parameter name.
#   PARAM_3_VALUE                       Third parameter value.
#   PARAM_3_DESC                        Third parameter description.
#   PARAM_3_DTYPE                       Third parameter data type.
#   PARAM_3_JSDOC_DTYPE                 Third parameter JSDoc data type.
#   PARAM_3_THROWS_DESC                 Third parameter JSDoc throws description.
#   OUTPUT_TS_DTYPE                     Output array TypeScript data type.
#   OUTPUT_TS_TYPED_ARRAY               Output array TypeScript typed array.
#   OUTPUT_DTYPE_KIND                   Output array data type kind.
#   DEFAULT_DTYPE                       Default output array data type.
#   DEFAULT_DTYPE_KIND                  Default output array data type kind.
#   DEFAULT_TYPED_ARRAY                 Default output typed array.
...
#   REPL_TEXT_PARAM_2_DESC              Second parameter description.
#   REPL_TEXT_PARAM_3_DESC              Third parameter description.
#   REPL_TEXT_OUTPUT_TYPED_ARRAYS       Output typed arrays.
...
alias=${ALIAS:-'triangular'}

# Define the package name:
pkg=${PKG:-'stdlib/random/array/triangular'}

# Define the base package name:
base_pkg=${BASE_PKG:-'stdlib/random/base/triangular'}
...
param_1_desc=${PARAM_1_DESC:-'minimum support'}
...
# Define the first PRNG parameter JSDoc throws description:
param_1_throws_desc=${PARAM_1_THROWS_DESC:-'must be a number'}

# Define the name of the second PRNG parameter:
param_2=${PARAM_2:-'b'}

# Define an example value for the second PRNG parameter:
param_2_value=${PARAM_2_VALUE:-'5.0'}

# Define the second PRNG parameter description:
param_2_desc=${PARAM_2_DESC:-'maximum support'}

# Define the second PRNG parameter data type:
param_2_dtype=${PARAM_2_DTYPE:-'number'}

# Define the second PRNG parameter JSDoc data type:
param_2_jsdoc_dtype=${PARAM_2_JSDOC_DTYPE:-'number'}

# Define the second PRNG parameter JSDoc throws description:
param_2_throws_desc=${PARAM_2_THROWS_DESC:-'must be a number'}

# Define the name of the third PRNG parameter:
param_3=${PARAM_3:-'c'}

# Define an example value for the third PRNG parameter:
param_3_value=${PARAM_3_VALUE:-'3.0'}

# Define the third PRNG parameter description:
param_3_desc=${PARAM_3_DESC:-'mode'}

# Define the third PRNG parameter data type:
param_3_dtype=${PARAM_3_DTYPE:-'number'}

# Define the third PRNG parameter JSDoc data type:
param_3_jsdoc_dtype=${PARAM_3_JSDOC_DTYPE:-'number'}

# Define the third PRNG parameter JSDoc throws description:
param_3_throws_desc=${PARAM_3_THROWS_DESC:-'must be a number'}

# Define the output array TypeScript data type:
output_ts_dtype=${OUTPUT_TS_DTYPE:-'RealFloatingPointAndGenericDataType'}

# Define the output array TypeScript typed array type definition:
output_ts_typed_array=${OUTPUT_TS_TYPED_ARRAY:-'FloatTypedArray'}
...
# Define the default output typed array constructor:
default_typed_array=${DEFAULT_TYPED_ARRAY:-'Float64Array'}

# Define a description fragment:
from_desc=${FROM_DESC:-'a triangular distribution'}

# Define a description fragment for use in the README:
readme_from_desc=${README_FROM_DESC:-'a [triangular][@stdlib/random/base/triangular] distribution'}

# Define the README heading:
readme_heading=${README_HEADING:-'Triangular Random Numbers'}

# Define the data type kind description:
readme_dtype_kind_desc=${README_DTYPE_KIND_DESC:-'real-valued floating-point data type'}

# Define the data type kind package:
readme_dtype_kind_pkg=${README_DTYPE_KIND_PKG:-'stdlib/array/typed-real-float-dtypes'}

# Define the REPL text main export description:
repl_text_main_desc=${REPL_TEXT_MAIN_DESC:-'Returns an array containing pseudorandom numbers drawn from a triangular distribution.'}

# Define the REPL text description for the `assign` method:
repl_text_assign_desc=${REPL_TEXT_ASSIGN_DESC:-'Fills an array with pseudorandom numbers drawn from a triangular distribution.'}

# Define the REPL text description for the `factory` method:
repl_text_factory_desc=${REPL_TEXT_FACTORY_DESC:-'Returns a function for creating arrays containing pseudorandom numbers drawn from a triangular distribution.'}

# Define the REPL text description for the first PRNG parameter:
repl_text_param_1_desc=${REPL_TEXT_PARAM_1_DESC:-'Minimum support.'}

# Define the REPL text description for the second PRNG parameter:
repl_text_param_2_desc=${REPL_TEXT_PARAM_2_DESC:-'Maximum support.'}

# Define the REPL text description for the third PRNG parameter:
repl_text_param_3_desc=${REPL_TEXT_PARAM_3_DESC:-'Mode.'}

# Define the REPL text list of output array constructors:
repl_text_output_typed_arrays=${REPL_TEXT_OUTPUT_TYPED_ARRAYS:-'Float64Array|Float32Array'}
...
this_dir="${base_dir}/@stdlib/random/array/scripts/scaffolds/ternary"
...
files=(
	...
	"benchmark/benchmark.float32.factory.js"
	"benchmark/benchmark.float32.js"
	"benchmark/benchmark.float64.assign.js"
	"benchmark/benchmark.float64.factory.js"
	"benchmark/benchmark.float64.js"
	"benchmark/benchmark.generic.assign.js"
	"benchmark/benchmark.generic.factory.js"
...
regex="s/\\{\\{PARAM_1_THROWS_DESC\\}\\}/${param_1_throws_desc}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_2\\}\\}/${param_2}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_2_VALUE\\}\\}/${param_2_value}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_2_DESC\\}\\}/${param_2_desc}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_2_DTYPE\\}\\}/${param_2_dtype}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_2_JSDOC_DTYPE\\}\\}/${param_2_jsdoc_dtype}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_2_THROWS_DESC\\}\\}/${param_2_throws_desc}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_3\\}\\}/${param_3}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_3_VALUE\\}\\}/${param_3_value}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_3_DESC\\}\\}/${param_3_desc}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_3_DTYPE\\}\\}/${param_3_dtype}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_3_JSDOC_DTYPE\\}\\}/${param_3_jsdoc_dtype}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{PARAM_3_THROWS_DESC\\}\\}/${param_3_throws_desc}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{OUTPUT_TS_DTYPE\\}\\}/${output_ts_dtype}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{OUTPUT_TS_TYPED_ARRAY\\}\\}/${output_ts_typed_array}/g;"
find_and_replace "${regex}"
...
regex="s/\\{\\{DEFAULT_TYPED_ARRAY\\}\\}/${default_typed_array}/g;"
find_and_replace "${regex}"
...
regex="s/\\{\\{REPL_TEXT_PARAM_2_DESC\\}\\}/${repl_text_param_2_desc}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{REPL_TEXT_PARAM_3_DESC\\}\\}/${repl_text_param_3_desc}/g;"
find_and_replace "${regex}"

regex="s/\\{\\{REPL_TEXT_OUTPUT_TYPED_ARRAYS\\}\\}/${repl_text_output_typed_arrays}/g;"
find_and_replace "${regex}"
