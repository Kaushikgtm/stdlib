...
param_1_jsdoc_dtype=${PARAM_1_JSDOC_DTYPE:-'PositiveNumber'}

# Define the first PRNG parameter JSDoc throws description:
param_1_throws_desc=${PARAM_1_THROWS_DESC:-'must be a positive number'}
...
repl_text_main_desc=${REPL_TEXT_MAIN_DESC:-'Returns an array containing pseudorandom numbers drawn from an exponential distribution.'}
...
repl_text_factory_desc=${REPL_TEXT_FACTORY_DESC:-'Returns a function for creating arrays containing pseudorandom numbers drawn from an exponential distribution.'}
...
this_dir="${base_dir}/@stdlib/random/array/scripts/scaffolds/unary"
