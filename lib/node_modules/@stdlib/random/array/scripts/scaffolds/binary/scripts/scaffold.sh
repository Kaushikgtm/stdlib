...
pkg=${PKG:-'stdlib/random/array/arcsine'}

# Define the base package name:
base_pkg=${BASE_PKG:-'stdlib/random/base/arcsine'}
...
from_desc=${FROM_DESC:-'an arcsine distribution'}

# Define a description fragment for use in the README:
readme_from_desc=${README_FROM_DESC:-'an [arcsine][@stdlib/random/base/arcsine] distribution'}
...
repl_text_main_desc=${REPL_TEXT_MAIN_DESC:-'Returns an array containing pseudorandom numbers drawn from an arcsine distribution.'}

# Define the REPL text description for the `assign` method:
repl_text_assign_desc=${REPL_TEXT_ASSIGN_DESC:-'Fills an array with pseudorandom numbers drawn from an arcsine distribution.'}

# Define the REPL text description for the `factory` method:
repl_text_factory_desc=${REPL_TEXT_FACTORY_DESC:-'Returns a function for creating arrays containing pseudorandom numbers drawn from an arcsine distribution.'}
...
this_dir="${base_dir}/@stdlib/random/array/scripts/scaffolds/binary"
