...
/**
* @name hasHasInstanceSymbolSupport
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/has-has-instance-symbol-support}
*/
setReadOnly( ns, 'hasHasInstanceSymbolSupport', require( '@stdlib/assert/has-has-instance-symbol-support' ) );
...
/**
* @name hasIsConcatSpreadableSymbolSupport
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/has-is-concat-spreadable-symbol-support}
*/
setReadOnly( ns, 'hasIsConcatSpreadableSymbolSupport', require( '@stdlib/assert/has-is-concat-spreadable-symbol-support' ) );
...
*/
setReadOnly( ns, 'hasMatchSymbolSupport', require( '@stdlib/assert/has-match-symbol-support' ) );
...
*/
setReadOnly( ns, 'hasReplaceSymbolSupport', require( '@stdlib/assert/has-replace-symbol-support' ) );
...
*/
setReadOnly( ns, 'hasSearchSymbolSupport', require( '@stdlib/assert/has-search-symbol-support' ) );
...
/**
* @name hasSplitSymbolSupport
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/has-split-symbol-support}
*/
setReadOnly( ns, 'hasSplitSymbolSupport', require( '@stdlib/assert/has-split-symbol-support' ) );
...
*/
setReadOnly( ns, 'hasToPrimitiveSymbolSupport', require( '@stdlib/assert/has-to-primitive-symbol-support' ) );
...
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-value}
*/
setReadOnly( ns, 'isAlmostSameValue', require( '@stdlib/assert/is-almost-same-value' ) );

/**
* @name isAlmostSameValueArray
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-value-array}
*/
setReadOnly( ns, 'isAlmostSameValueArray', require( '@stdlib/assert/is-almost-same-value-array' ) );

/**
* @name isAlmostSameValueFloat64Array
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-almost-same-value-float64array}
*/
setReadOnly( ns, 'isAlmostSameValueFloat64Array', require( '@stdlib/assert/is-almost-same-value-float64array' ) );
...
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-struct}
*/
setReadOnly( ns, 'isStruct', require( '@stdlib/assert/is-struct' ) );

/**
* @name isStructConstructorLike
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/assert/is-struct-constructor-like}
*/
setReadOnly( ns, 'isStructConstructorLike', require( '@stdlib/assert/is-struct-constructor-like' ) );
